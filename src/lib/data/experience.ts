...
const items: Array<Experience> = [
	...
	},
	{
		...
		description:
			'Worked as a Data Engineer at Tata Consultancy Services (TCS), contributing to large-scale enterprise data platforms by designing, optimizing, and maintaining robust data pipelines. Played a key role in improving data reliability, performance, and accessibility through advanced SQL development, ETL optimization using Informatica PowerCenter, and database automation with PL/SQL. Collaborated closely with cross-functional teams to ensure data quality, resolve high-priority production issues, and consistently meet stringent SLA requirements in a fast-paced, client-facing environment.<br><br> <center><b>Highlights</b></center><br><ul><li><b></b>•	Improved data quality by 25% by building documented SQL, dbt, and Python validation checks, resulting in consistent schemas, trustworthy dashboards, fewer stakeholder escalations, and stronger governance controls.</li><br> <li><b></b>•	Reduced reporting latency by 40% by orchestrating Airflow, Informatica and AWS data workflows for telecom transaction data, resulting in analytics ready tables supporting Grafana dashboards. </li><br> <li><b></b>•	Resolved 150+ high-priority production incidents, using root-cause analysis and data integrity checks to reduce recurring failures by 35% and enhance system performance.</li></ul>',
